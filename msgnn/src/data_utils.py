...
path_csse_us_confirmed = '../data/time_series_covid19_confirmed.csv'
...
path_csse_us_death = '../data/time_series_covid19_deaths.csv'
...
def generate_graph(dump_fp, max_neighbor_num=50, dump_flag=True):
...
if __name__ == "__main__":
    ...
    fp_graph = '../data/graph.cpt'
    if not os.path.exists(fp_graph):
        generate_graph(fp_graph, max_neighbor_num=50)
